...
//	ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 1, ADC_SampleTime_1Cycles5 );	//ADC1,ADC通道3,规则采样顺序值为1,采样时间为1.5周期
	ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 1, ADC_SampleTime_1Cycles5 );	//ADC1,ADC通道3,规则采样顺序值为1,采样时间为1.5周期
//	ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 3, ADC_SampleTime_1Cycles5 );	//ADC1,ADC通道3,规则采样顺序值为1,采样时间为1.5周期
...
float AD_DA_Fun(float Adc_v)
{
	float Dac_v;
	Dac_v=Adc_v*Adc_v*Adc_v*0.5370-3.4920*Adc_v*Adc_v+7.7524*Adc_v-5.7686;
	return Dac_v;
}
